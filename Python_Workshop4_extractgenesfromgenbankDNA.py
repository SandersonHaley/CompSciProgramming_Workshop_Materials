...
def parse_args():
    parser = argparse.ArgumentParser(description='Extracts a specific sequence gene from a genbank file and outputs it as a .fasta file')
        ...
        for feature in record.features:
            if feature.type == 'CDS':
                ...
                if 'gene' in feature.qualifiers and feature.qualifiers['gene'][0] == geneName:
                    ...
                    # Create a SeqRecord object of the gene sequence
                    gene_record = SeqRecord(gene_sequence, id=geneName)
                    # Save the gene sequence as a .fasta file
                    SeqIO.write(gene_record, geneName + '_' + genbank_file + '.fasta', 'fasta')
